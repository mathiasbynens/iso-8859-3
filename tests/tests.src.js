(function(root) {
	...
	// The `iso88593` object to test
	var iso88593 = root.iso88593 || (root.iso88593 = (
		iso88593 = load('../iso-8859-3.js') || root.iso88593,
		iso88593 = iso88593.iso88593 || iso88593
	));
	...
	QUnit.module('iso-8859-3');

	test('iso88593.encode', function() {
		equal(
